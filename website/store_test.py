...
def test_total_cart_pass():
    ...
    sesion.addToCart(tShirt=Tshirt(price=10.25, prints=[Print(cost=5), Print(cost=10)]))
    sesion.addToCart(tShirt=Tshirt(price=29.50, prints=[Print(cost=3), Print(cost=12)]))
    sesion.addToCart(tShirt=Tshirt(price=33.20, prints=[Print(cost=8), Print(cost=13)]))
    sesion.addToCart(tShirt=Tshirt(price=10.25, prints=[Print(cost=15), Print(cost=4)]))
